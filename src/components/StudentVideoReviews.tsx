...
const videoReviews: VideoReview[] = [
  {
    id: "video-1",
    youtubeUrl: "https://youtu.be/qnaB7iLX93o?si=gkV8fm6Uk4b46v9p",
    collegeName: "Hansraj College",
    course: "BSc (H) Chemistry",
    duration: "27:31",
  },
  {
    id: "video-2",
    youtubeUrl: "https://youtu.be/eeWZvn99Rvo?si=zRb_ZRACvleuChut",
  ...
  {
    id: "video-3",
    youtubeUrl: "https://youtu.be/wpvH3vKN5JU?si=fTGs05ExPl-5aXxC",
    collegeName: "Lady Irwin College",
    course: "BSc (H) Food Technology",
    duration: "12:23",
  },
  {
    id: "video-4",
    youtubeUrl: "",
    collegeName: "Institute of Home Economics",
    course: "BSc (H) Food Technology",
    duration: "7:23",
  },
];
